...
export const initialCards = [
  {
    ...
    effortTotal: { dev: 4, test: 2, uat: 1 },
    effortLeft: { dev: 4, test: 2, uat: 1 },
  ...
  },
  {
    ...
    type: 'padrao',
    effortTotal: { dev: 3, test: 1, uat: 2 },
    effortLeft: { dev: 3, test: 1, uat: 2 },
    columnId: 'col-backlog',
    createdAt: 1,
    startedAt: null,
    completedAt: null,
  ...
  },
  {
    ...
    type: 'urgente',
    effortTotal: { dev: 2, test: 1, uat: 1 },
    effortLeft: { dev: 2, test: 1, uat: 1 },
  ...
  },
  {
    ...
    type: 'data-fixa',
    effortTotal: { dev: 1, test: 1, uat: 2 },
    effortLeft: { dev: 1, test: 1, uat: 2 },
    columnId: 'col-backlog',
    createdAt: 1,
    startedAt: null,
    completedAt: null,
  ...
  },
  {
    ...
    type: 'intangivel',
    effortTotal: { dev: 5, test: 2, uat: 1 },
    effortLeft: { dev: 5, test: 2, uat: 1 },
    columnId: 'col-backlog',
    createdAt: 1,
    startedAt: null,
    completedAt: null,
