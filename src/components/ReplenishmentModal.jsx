    ...
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(15, 23, 42, 0.85)', backdropFilter: 'blur(8px)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 999999 }}>
      <div className="modal-content animate-fade-in" style={{ maxWidth: '600px', borderTop: '4px solid var(--accent-emerald)', position: 'relative' }}>
        ...
        <div style={{ color: 'var(--text-primary)', fontSize: '1rem', lineHeight: '1.6', marginBottom: '24px' }}>
          <p>
            A Reunião de Replenishment foca nos <strong>itens que estão no Backlog aguardando seleção</strong>. O objetivo é decidir quais cruzarão o Ponto de Comprometimento.
          </p>
          ...
          <ul style={{ listStyleType: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <li style={{ background: 'var(--bg-secondary)', padding: '12px', borderRadius: '8px', borderLeft: '3px solid var(--accent-blue)', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                <strong>1. Quais os itens mais importantes no Backlog?</strong><br/>
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Olhando para o pool de opções, quais cartões trarão mais valor de negócio ou reduzirão mais risco se iniciados agora?</span>
              </div>
            </li>
            ...
            <li style={{ background: 'var(--bg-secondary)', padding: '12px', borderRadius: '8px', borderLeft: '3px solid var(--accent-amber)', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Verifique o Backlog em busca de itens da Classe de Serviço "Urgente" ou "Data Fixa" próxima. Eles devem ter prioridade na seleção.</span>
              </div>
            </li>
            ...
            <li style={{ background: 'var(--bg-secondary)', padding: '12px', borderRadius: '8px', borderLeft: '3px solid var(--accent-purple)', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                <strong>3. Os itens do Backlog estão maduros (Ready)?</strong><br/>
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>Temos as informações necessárias para começar a trabalhar nestes itens? Não selecione cartões mal especificados.</span>
              </div>
            </li>
            ...
            <li style={{ background: 'var(--bg-secondary)', padding: '12px', borderRadius: '8px', borderLeft: '3px solid var(--accent-emerald)', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                <strong>4. Temos capacidade (WIP) disponível?</strong><br/>
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>A coluna "Selecionado (Ready)" tem espaço? O Kanban é um sistema puxado: só selecionamos itens do Backlog se houver vagas no sistema.</span>
              </div>
            </li>
          </ul>
        </div>
